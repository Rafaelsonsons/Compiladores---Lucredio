package br.ufscar.dc.compiladores.alguma.sintatico;// Generated from C:/Users/felip/Desktop/Docs_Yuya/UFSCar/COMPL/T2Teste/src/main/antlr4.br.ufscar.dc.compiladores.alguma.sintatico/Alguma.g4 by ANTLR 4.13.2
...
public class AlgumaParser extends Parser {
	...
	public final DeclaracoesContext declaracoes() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 728L) != 0)) {
				{
				setState(106);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
